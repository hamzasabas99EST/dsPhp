  ...
  $("#search").keyup(function(e){
    ...
    var div=$(".autocomplete-items");
      ...
      if(q!=''){
        ...
        $.ajax({
              url :'http://localhost/dsPhp/User/searchUser',
              method:'POST',
              data:{q},
    ...
    $(".comments").keyup(function(e){
      if(e.keyCode==13){
          ...
          $.ajax({
              url :'http://localhost/dsPhp/Pub/addComment',
              method:'POST',
              data:{id_pub,contenu},
              success:function(res){
                 var div=  $("<div class='card-comment'> <img class='img-circle img-sm' src='http://localhost/dsPhp/uploads/users/"+img+"'><div class='comment-text'> <span class='username'>"+name+"<span class='text-muted float-right'>Maintenant</span></span>"+contenu+" </div> </div>");
    ...
    $(".delete").click(function(e){
      e.preventDefault();
        ...
        $.ajax({
          url :'http://localhost/dsPhp/Pub/deleteComment',
          method:"POST",
          data:{id_commentaire},
          success:function(res){
    ...
    $(".likes").click(function(e){
       ...
       $.ajax({
          url :'http://localhost/dsPhp/Pub/likePub',
          method:"POST",
          data:{id_pub},
          success:function(res){
    ...
    $(".send").click(function(e){
      ...
      $.ajax({
        url :'http://localhost/dsPhp/User/addFriend',
        method:"POST",
        data:{id_rec},
        success:function(res){
    ...
    $(".decisions").click(function(e){
        ...
        $.ajax({
          url :'http://localhost/dsPhp/User/makeDecision',
          method:"POST",
          data:{id_inv,status},
          success:function(res){
             $(this).text(text)
